...
set the working directory as the absolute path of the project location CSX415-project and then run main.R file located in folder /CSX415-project/phone_mark/pkgs/modelpkgs/R/.
